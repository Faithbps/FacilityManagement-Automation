describe("validate loin landing page", () => {
    ...
    it('verify user', () => {
        ...
        cy.wait(3000)
        // cy.get('#react-aria4730741033-5-tabpane-1 > .inner-tabs > .col-12 > .c-header > :nth-child(2) > .App > .DateRangePicker > :nth-child(1) > .DateRangePickerInput > :nth-child(3) > #end-date').click(({force: true}));
        cy.wait(3000)
        //cy.get('#react-aria316460318-5-tabpane-1 > .inner-tabs > .col-12 > .c-header > :nth-child(2) > .App > .DateRangePicker > :nth-child(1) > .DateRangePickerInput > :nth-child(3) > #end-date').click(({force: true}));
        //cy.get('.CalendarDay__today').click();
        cy.wait(3000)
        cy.get('ul > :nth-child(4) > a').click(({force: true}));
        cy.wait(3000)
